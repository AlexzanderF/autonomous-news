...
HEADLINES_PICKER_THINKING_LEVEL = os.getenv('HEADLINES_PICKER_THINKING_LEVEL', 'minimal')
ARTICLE_GENERATION_THINKING_BUDGET = int(os.getenv('ARTICLE_GENERATION_THINKING_BUDGET', 0))
ARTICLE_GENERATION_THINKING_LEVEL = os.getenv('ARTICLE_GENERATION_THINKING_LEVEL', 'minimal')
THUMBNAIL_PICKER_THINKING_BUDGET = int(os.getenv('THUMBNAIL_PICKER_THINKING_BUDGET', 0))
THUMBNAIL_PICKER_THINKING_LEVEL = os.getenv('THUMBNAIL_PICKER_THINKING_LEVEL', 'minimal')
...
MALFORMED_FUNCTION_REASON_STRING = "MALFORMED_FUNCTION_CALL"
