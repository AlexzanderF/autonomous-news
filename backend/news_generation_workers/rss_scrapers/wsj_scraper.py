...
class WSJScraper(BaseRSSScraper):
    ...
    def scrape_market_news(self, num_articles: int = 200, after_date: Optional[datetime] = None) -> List[ScrapedArticleDTO]:
        """
        Scrape articles from WSJ Markets RSS feed.
        ...
        return self._scrape_feed(url, num_articles, after_date, "WSJ Markets RSS")

    def scrape_economy_news(self, num_articles: int = 200, after_date: Optional[datetime] = None) -> List[ScrapedArticleDTO]:
        """
        Scrape articles from WSJ Economy RSS feed.
        ...
        return self._scrape_feed(url, num_articles, after_date, "WSJ Economy RSS")
