  ...
  return (
    <article className="max-w-none">
      <div className="article-content text-slate-900 leading-relaxed">
        <ReactMarkdown
          components={{
            h2: ({ node: _node, ...props }) => <h2 className="font-bold text-slate-900 mt-6 mb-6" {...props} />,
            h3: ({ node: _node, ...props }) => <h3 className="font-bold text-slate-900 mt-6 mb-6" {...props} />,
            h4: ({ node: _node, ...props }) => <h4 className="font-bold text-slate-900 mt-6 mb-6" {...props} />,
